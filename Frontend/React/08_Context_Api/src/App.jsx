...
const App = () => {
  ...
  let {isCartOpen} = useContext(MyCart)
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-800 text-white flex flex-col gap-4">
      <Navbar/>
      ...
      {isCartOpen ? (
        ...
        <div className="grid grid-cols-5 flex gap-2 flex-wrap">
          {products.map((val) => {
